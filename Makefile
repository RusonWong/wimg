CC	:= g++
CFLAGS	:= -levent -pthread -lmemcached -std=gnu++11
OBJECTS	:= main.cpp ThreadsMain.o EventQueue.o EventHandler.o WorkerThreads.o EntityManager.o LocalStorage.o FTProtocol.o MCConnector.o
...
EventHandler.o: EventHandler.cpp EventHandler.h LibeventThread.h  FTProtocol.o
	$(CC) EventHandler.cpp -c -std=gnu++11
